...
class InstallationPage(Gtk.Box):
    ...
    def install_system(self):
        ...
        cmd = [
            ...
            "rsync",
            "-aAXHv",
            "--exclude=/run/archiso/airootfs/dev/*",
            "--exclude=/run/archiso/airootfs/proc/*",
            "--exclude=/run/archiso/airootfs/sys/*",
            "--exclude=/run/archiso/airootfs/tmp/*",
            "--exclude=/run/archiso/airootfs/run/*",
            "--exclude=/run/archiso/airootfs/mnt/*",
            "--exclude=/run/archiso/airootfs/media/*",
            "--exclude=/run/archiso/airootfs/lost+found",
        ...
        subprocess.run(["sudo", "mount", "--bind", "/run/archiso/airootfs/dev", f"{MNT}/dev"])
        subprocess.run(["sudo", "mount", "--bind", "/run/archiso/airootfs/proc", f"{MNT}/proc"])
        subprocess.run(["sudo", "mount", "--bind", "/run/archiso/airootfs/sys", f"{MNT}/sys"])
        subprocess.run(["sudo", "mount", "--bind", "/run/archiso/airootfs/run", f"{MNT}/run"])
        ...
        subprocess.run(["sudo", "cp", "/run/archiso/bootmnt/arch/boot/x86_64/vmlinuz-linux", "/mnt/boot"])
        ...
        self.arch_chroot(["pacman", "-Rns", "yavix-center", "--noconfirm"])
        self.arch_chroot(["pacman", "-Sy", "yavix-center", "--noconfirm"])
